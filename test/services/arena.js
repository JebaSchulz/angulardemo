...
describe('Arena', function() {
  ...
  describe('Determine Winner', function() {
    ...
    it('should determine a winner if the matchup is not equal and opponent is stronger', inject(function(Arena) {
      var outcome = Arena.determineWinner(this.rhino, this.alligator, this.swamp);
      outcome.should.equal('opponent');
    }));

    it('should determine a draw if the matchup is equal', inject(function(Arena) {
      var outcome = Arena.determineWinner(this.alligator, this.alligator, this.swamp);
